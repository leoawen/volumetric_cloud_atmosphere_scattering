...
This project is open-source and available under the **MIT License**. See the [LICENSE](https://github.com/leoawen/volumetric_cloud_atmosphere_scattering/blob/main/LICENSE) file for more info.
